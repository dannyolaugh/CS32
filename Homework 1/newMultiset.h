...
//  MoveOver
//
//  Created by Daniel O'Laughlin on 1/15/15.
//  Copyright (c) 2015 Daniel O'Laughlin. All rights reserved.
//

#ifndef __MoveOver__File__
#define __MoveOver__File__
...
public:
    ...
    int get(int i, ItemType& value) const;   //is this const?
...
#endif /* defined(__MoveOver__File__) */
